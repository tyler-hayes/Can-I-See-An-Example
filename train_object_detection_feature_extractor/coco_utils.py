...
import train_object_detection_feature_extractor.transforms as T
...
class CocoDetection(torchvision.datasets.CocoDetection):
    def __init__(self, img_folder, ann_file, transforms, included=[]):
...
def get_coco(root, image_set, transforms, mode='instances', included=[]):
    ...
    dataset = CocoDetection(img_folder, ann_file, transforms=transforms, included=included)
